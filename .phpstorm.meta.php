...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/chrisganzert/PhpstormProjects/Plants/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/chrisganzert/PhpstormProjects/Plants/public/storage','logging.default',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','event-sourcing.auto_discover_projectors_and_reactors','event-sourcing.auto_discover_base_path',
'event-sourcing.projectors','event-sourcing.reactors','event-sourcing.queue','event-sourcing.catch_exceptions','event-sourcing.stored_event_model',
'event-sourcing.stored_event_repository','event-sourcing.snapshot_repository','event-sourcing.snapshot_model','event-sourcing.stored_event_job','event-sourcing.enforce_event_class_map',
'event-sourcing.event_class_map','event-sourcing.event_serializer','event-sourcing.event_normalizers','event-sourcing.cache_path','event-sourcing.dispatch_events_from_aggregate_roots',
...
'debugbar.queries.explain','boost.browser-logs','livewire.update',
'livewire.upload-file','livewire.preview-file','home','dashboard','settings.profile','settings.password','settings.appearance','plants.index',
'plants.create-test','plants.minimal-test','plants.create-fixed','plants.create','plants.request',
'plants.show','plants.edit','admin.dashboard','login','register',
'password.request','password.reset','verification.notice','verification.verify','password.confirm',
'logout','storage.local',);
        registerArgumentsSet('views', 
'components.action-message','components.alert','components.app-logo','components.app-logo-icon','components.auth-header',
'components.auth-session-status','components.avatar','components.form.checkbox','components.form.fieldset','components.form.grid',
'components.form.input','components.form.select','components.form.textarea','components.layouts.app','components.layouts.app.header',
...
'components.placeholder-pattern','components.plants.image','components.plants.layout','components.settings.layout','dashboard',
...
'livewire.auth.verify-email','livewire.pages.admin.dashboard','livewire.pages.plants.create','livewire.pages.plants.edit','livewire.pages.plants.index',
'livewire.pages.plants.request','livewire.pages.plants.show','livewire.settings.appearance','livewire.settings.delete-user-form','livewire.settings.password',
'livewire.settings.profile','partials.head','partials.settings-heading','volt-livewire::auth.confirm-password','volt-livewire::auth.forgot-password',
'volt-livewire::auth.login','volt-livewire::auth.register','volt-livewire::auth.reset-password','volt-livewire::auth.verify-email','volt-livewire::pages.admin.dashboard',
'volt-livewire::pages.plants.create','volt-livewire::pages.plants.edit','volt-livewire::pages.plants.index','volt-livewire::pages.plants.request','volt-livewire::pages.plants.show',
